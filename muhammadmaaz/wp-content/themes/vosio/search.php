...
get_header();
global $wp_query;
$data  = \VOSIO\Includes\Classes\Common::instance()->data( 'search' )->get();
                	...
                	<div class="blog__list">
                        ...
                        <?php else : ?>
                            <div class="widget__search wcfadeUp2">
                            	<p class="mb-4"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'vosio' ); ?></p>
								<?php get_search_form() ?>
                            </div>
                        <?php endif; ?>
