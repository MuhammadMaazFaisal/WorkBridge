...
class Options {
	 ...
	 * @var string
	 */
	private $opt_name = 'vosio' . '_options';
	...
	private $page_slug = 'vosio' . '_options';
	...
	private $docs_link = 'https://docs.themewisdom.com';
	...
	function init() {
		...
		$this->menu_title = esc_html__( 'VOSIO Options', 'vosio' );
		$this->page_title = esc_html__( 'VOSIO Options', 'vosio' );
	...
	function args() {
		...
		$args['share_icons'][] = array(
			'url'   => 'https://www.pinterest.com/themewisdom_/',
			'title' => 'Visit us on Pinterest',
			'icon'  => 'el el-pinterest',
		);
		$args['share_icons'][] = array(
			'url'   => 'https://www.facebook.com/people/@/themewisdom',
			'title' => 'Like us on Facebook',
			'icon'  => 'el el-facebook',
		);
		$args['share_icons'][] = array(
			'url'   => 'https://twitter.com/themewisdom',
			'title' => 'Follow us on Twitter',
			'icon'  => 'el el-twitter',
		);
		$args['share_icons'][] = array(
			'url'   => 'https://www.linkedin.com/company/themewisdom-web-arcade',
	...
	function helpTabs() {
		...
		$tabs = array(
			array(
				'id'      => 'redux-help-tab-1',
				'title'   => esc_html__( 'Theme Information 1', 'vosio' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'vosio' ),
			),
			array(
				'id'      => 'redux-help-tab-2',
				'title'   => esc_html__( 'Theme Information 2', 'vosio' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'vosio' ),
			),
		);
		...
		$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'vosio' ) . '</p>';
	...
	function sections() {
		...
		$sections_path = apply_filters( 'vosio_redux_sections', $sections_path );
		...
		foreach ( $sections_path as $key => $file ) {
			...
			if ( file_exists( $file ) ) {
				...
				$options = apply_filters( "vosio_redux_sections_{$key}", $options );
