 ...
 */
//vosio_load_default_hooks
function vosio_load_default_hooks() {

	$config = vosio_WSH()->config( 'default' );
...
/**
 * [vosio_main_header_area description]
 *
 * @return [type] [description]
 */

//vosio_main_header_area
function vosio_main_header_area() {
	...
	//need to change
	if ( $header == 'header_v1' ) {
		vosio_template_load( 'templates/header/default-header.php' );
	} elseif ( $header == 'header_v2' ) {
		vosio_template_load( 'templates/header/header_v2.php' );
	} else {
		vosio_template_load( 'templates/header/default-header.php' );
	}
}
...
/**
 * [vosio_main_footer_area description]
 *
 * @return [type] [description]
 */
//vosio_main_footer_area
function vosio_main_footer_area() {
	...
	//need to change
	if ( $footer == 'footer_v1' ) {
		vosio_template_load( 'templates/footer/default-footer.php' );
	} else {
		vosio_template_load( 'templates/footer/default-footer.php' );
	}
}
...
/**
 * [vosio_sidebar description]
 *
 * @return [type] [description]
 */
//vosio_sidebar
function vosio_sidebar( $data ) {

	vosio_template_load( 'templates/sidebar.php', compact( 'data' ) );
}

/**
 * [vosio_banner description]
 *
 * @return [type] [description]
 */
//vosio_banner
function vosio_banner( $data ) {

	vosio_template_load( 'templates/banner/banner.php', compact( 'data' ) );
