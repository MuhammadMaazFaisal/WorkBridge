...
namespace VOSIOPLUGIN\Inc\Post_Types;

use VOSIOPLUGIN\Inc\Abstracts\Post_Type;
...
class Project extends Post_Type {
	...
	public static function init() {
		...
		self::instance()->singular  = esc_html__( 'Project', 'wpvosio' );
		self::instance()->plural    = esc_html__( 'Projects', 'wpvosio' );
