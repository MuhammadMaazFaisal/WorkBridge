 ...
 * @since 1.0.0
 */
class Our_Project_V8 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Project V8', 'vosio' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_project_v8',
			[
				'label' => esc_html__( 'Our Project V8', 'vosio' ),
			]
		);
		$this->add_control(
			'text_limit',
                                ...
                                <div class="content-box">
                                    <div class="content">
                                        <div class="clearfix">
                                            <div class="inner">
                                                <div class="image-box">
                                                    <div class="image"><?php the_post_thumbnail('vosio_681x595'); ?></div>
                                                </div>
                                                <div class="subtitle"><?php echo implode( ', ', (array)$term_list );?></div>
                                                <h1><span><?php echo wp_trim_words( get_the_title(), 1, '...' );?></span></h1>
                                                <div class="slide-count"><span class="current"><?php $count = sprintf('%02d', $count); echo $count; ?></span><span class="line"></span><span class="total">05</span></div>
                                                <div class="text-content">
                                                    <div class="inner-box">
                                                        <div class="text"><div class="ttl"><?php echo (get_post_meta( get_the_id(), 'sub_heading', true ));?></div><?php echo wp_kses(vosio_trim(get_the_content(), $settings['text_limit']), true); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
