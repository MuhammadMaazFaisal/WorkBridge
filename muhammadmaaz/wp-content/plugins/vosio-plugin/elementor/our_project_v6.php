 ...
 * @since 1.0.0
 */
class Our_Project_V6 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Project V6', 'vosio' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_project_v6',
			[
				'label' => esc_html__( 'Our Project V6', 'vosio' ),
			]
		);
		$this->add_control(
			'text_limit',
                                ...
                                <div class="auto-container">
                                    <div class="content-box">
                                        <div class="content">
                                            <div class="clearfix">
                                                <div class="inner">
                                                    <h4><?php echo implode( ', ', (array)$term_list );?></h4>
