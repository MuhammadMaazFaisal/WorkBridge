 ...
 * @since 1.0.0
 */
class Our_Project_V9 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Projects V9', 'vosio' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_project_v9',
			[
				'label' => esc_html__( 'Our Projects V9', 'vosio' ),
			]
		);
		$this->add_control(
			'text_limit',
                                ...
                                <div class="pager-box">
                                    <div class="pager-two">
                                        <?php 
											...
											$post_thumbnail_url = wp_get_attachment_url($post_thumbnail_id);
										?>
                                        <a href="" class="pager-item <?php if($i == 1) echo 'active'; ?>" data-slide-index="0"><div class="inner"><div class="text"><?php echo (get_post_meta( get_the_id(), 'sub_heading', true ));?><?php echo wp_kses(vosio_trim(get_the_content(), $settings['text_limit']), true); ?></div></div></a>
