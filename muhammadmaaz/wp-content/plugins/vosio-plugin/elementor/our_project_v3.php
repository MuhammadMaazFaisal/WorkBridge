...
class Our_Project_V3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Projects V3', 'vosio' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_project_v3',
			[
				'label' => esc_html__( 'Our Projects V3', 'vosio' ),
			]
		);
		$this->add_control(
			'query_number',
	...
	protected function render() {
        ...
        <!-- Portfolio Section -->
        <section class="portfolio-one alternate">            
            <div class="auto-container">
                <div class="row clearfix">
					...
					?>
                    <!--Portfolio Item-->
                    <div class="portfolio-item-one col-xl-4 col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box">
